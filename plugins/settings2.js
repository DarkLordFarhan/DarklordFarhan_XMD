const { gmd } = require("../darklord/gmdCmds");
const { getSetting, setSetting } = require("../darklord/database/settings");
const {
  getGroupSetting,
  setGroupSetting,
...
const { clearAllSudo, getSudoNumbers } = require("../darklord/database/sudo");
const {
  getAllUsersNotes,
  deleteNoteById,
  updateNoteById,
