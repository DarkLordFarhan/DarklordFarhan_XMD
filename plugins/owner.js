...
gmd(
  ...
  async (from, Gifted, conText) => {
    ...
    const { convertLidToJid } = require("../darklord/connection/serializer");
...
gmd(
  ...
  async (from, Gifted, conText) => {
    ...
    const { downloadMediaMessage } = require("../darklord/connection/serializer");
    const { isJidGroup } = require("gifted-baileys");
    ...
    try {
      ...
      if (msgType === "conversation" || msgType === "extendedTextMessage") {
        ...
        try {
          ...
          const altDownload =
            require("../darklord/connection/serializer").downloadMediaMessage;
