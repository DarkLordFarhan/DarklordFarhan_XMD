const { gmd, getGroupMetadata, getLidMapping } = require("../darklord");
const { getGroupSetting, setGroupSetting } = require("../darklord/database/groupSettings");
...
gmd(
  ...
  async (from, Gifted, conText) => {
    ...
    const { isSuperUser } = require("../darklord/database/sudo");
