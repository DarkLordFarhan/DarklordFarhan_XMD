...
async function loadSession() {
    try {
        ...
        if (headerCheck !== "LordFarhan-XMD" || !b64Check) {
            throw new Error("❌ Invalid session format. Expected 'LordFarhan-XMD~.....'");
        }
        ...
        if (!b64Check.startsWith('H4sI')) {
            ...
            if (!fetched.startsWith('LordFarhan-XMD~H4sI')) {
        ...
        if (header !== "LordFarhan-XMD" || !b64data) {
            throw new Error("❌ Invalid session format. Expected 'LordFarhan-XMD~.....'");
        }
